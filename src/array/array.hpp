#ifndef CONTAINERS_ARRAY_ARRAY_HPP
#define CONTAINERS_ARRAY_ARRAY_HPP
...
public:
    ...
    array(std::initializer_list<value_type> const &items) {
        if (items.size() != N)
            throw std::out_of_range("Количество элементов должно быть равно размеру массива.");
...
#endif  // CONTAINERS_ARRAY_ARRAY_HPP
